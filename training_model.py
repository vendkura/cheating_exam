...
# training_set = train_datagen.flow_from_directory('dataset_images/invigi_train',
#                                                  target_size = (256, 256),
#                                                  batch_size = 5,
#                                                  class_mode = 'binary')
# #input_shape = (256, 256, 3) so target image size is also 256x256
# test_set = test_datagen.flow_from_directory('dataset_images/invi_test',
#                                             target_size = (256, 256),
#                                             batch_size = 1,
#                                             class_mode = 'binary')
...
# import numpy as np
# string1='dataset_images/invi_validation/Validation_image ('
# a=1
...
# 1 - Convolution (Using Input layer as suggested by the warning)
...
# Calculate steps per epoch and validation steps based on dataset size and batch size
